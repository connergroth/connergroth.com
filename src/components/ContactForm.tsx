    ...
    <div className="mt-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          >
            <div className="absolute inset-0 bg-blue-600 border border-blue-600 rounded-md"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 rounded-md"></div>
