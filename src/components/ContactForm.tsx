    ...
    <div className="mt-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <button 
            type="submit" 
            className="relative h-12 px-6 flex justify-center items-center w-full md:w-auto transition-all duration-300 hover:opacity-90 hover:scale-105 active:scale-[0.98] group"
            disabled={isSubmitting}
          >
            <div className="absolute inset-0 bg-blue-500 border border-blue-500 rounded-md"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-md"></div>
            <div className="text-center text-white text-sm font-sans font-medium z-10 flex items-center">
              {isSubmitting ? (
                <>
