...
const ContactForm = () => {
  ...
  return (
    <div className="mt-6">
      {isSuccess && (
        <div className="bg-[#2563eb]/10 p-4 mb-6 rounded-md text-center border border-[#2563eb]/20">
          <p className="text-[#60a5fa] font-medium">Message sent successfully!</p>
          <p className="text-gray-300 text-sm mt-1">Thank you for reaching out. I'll get back to you soon.</p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <input 
            ...
            className="w-full px-4 py-2 bg-[#070a0d] bg-opacity-60 border border-gray-800 rounded-md focus:outline-none focus:border-gray-600"
            required
          />
        </div>
        ...
        <div className="mb-6">
          ...
          <textarea 
            ...
            rows={4}
            className="w-full px-4 py-2 bg-[#070a0d] bg-opacity-60 border border-gray-800 rounded-md focus:outline-none focus:border-gray-600 resize-none"
            required
          ></textarea>
        </div>
