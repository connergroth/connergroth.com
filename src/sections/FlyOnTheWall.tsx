      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 bg-[#2563eb]/90 hover:bg-[#2563eb] hover:scale-105 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 mb-6 group"
          >
            View PulsePlan
