...
const ProjectCategory: React.FC<{ title: string, projects: Project[] }> = ({ title, projects }) => (
  <>
    ...
    <div className="projects-container">
      <div className="project-list flex flex-col md:flex-row overflow-x-auto no-scrollbar md:gap-8 cursor-grab">
        {projects.map((project, index) => (
          <article key={index} className="flex mx-2 md:mx-0 my-10 rounded-lg bg-[#070a0d] bg-opacity-60 shadow">
              ...
              <div className="p-4 flex flex-col grow justify-between">
                ...
                <div>
                  ...
                  <div className="flex flex-row justify-between">
                    {project.liveUrl && (
                      <a className="learn-more-btn text-xs py-1.5" href={project.liveUrl} target="_blank" rel="noopener noreferer">
                    ...
                    {project.githubUrl && (
                      <a className="learn-more-btn text-xs py-1.5" href={project.githubUrl} target="_blank" rel="noopener noreferer">
